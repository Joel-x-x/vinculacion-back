...
public interface ICooperantesQueryService
{
    ...
    Task<ResultResponse<CooperantesCreateRecord>> CreateCooperante(CooperantesCreateRecord cooperantesCreateRecord);
    Task<ResultResponse<CooperantesUpdateRecord>> UpdateCooperante(CooperantesUpdateRecord cooperantesUpdateRecord);
