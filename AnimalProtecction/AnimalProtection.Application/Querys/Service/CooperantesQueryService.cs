...
public class CooperantesQueryService : ICooperantesQueryService
{
    ...
    public async Task<ResultResponse<CooperantesRecord>> GetCooperanteById<T>(Guid id)
    {
        ...
        if (cooperante == null)
        {
            return ResultResponse<CooperantesRecord>.Failure($"No se encontr� el cooperante con el id: {id}", 404);
        }
    ...
    public async Task<ResultResponse<bool>> DeleteCooperante(Guid id)
    {
        ...
        if(cooperante == null)
        {
            return ResultResponse<bool>.Failure($"No se encontr� el cooperante con el id: {id}", 404);
        }
